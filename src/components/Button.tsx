...
export default function Button({
  ...
  return (
    ...
    >
      <span
        className={clsx(
          "absolute inset-0 z-0 h-full translate-y-9 bg-pallets-400 transition-transform  duration-300 ease-in-out group-hover:translate-y-0",
        )}
      />
      <span className="absolute inset-0 z-0 h-full translate-y-9 bg-pallets-300 transition-transform duration-300 ease-in-out
